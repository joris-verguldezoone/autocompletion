...
<header> 
    ...
    echo '<div class="mise_en_forme_result_recherche_center_element">';
        echo '<div class="mise_en_forme_result_recherche_a" style="color:white; font-size:2em;">';
            echo $fetch['mot'];
            echo '<img class="img_size" src="'.$fetch['img'].'">';
        echo '</div>';
    echo '</div>';
    ?>
    </main>
